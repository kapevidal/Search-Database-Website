    ...
    <header>
        ...
        <main role="main" class="container">
 	        <div class="jumbotron jumbotron-result">
                <h1 class="text-center titlesindex"> Search History</h1>
                <p class="text-center">Contains all the search entries. Feel free to check it out.</p>
		        ...
		        $.ajax({
		            ...
		            success: function(data){
		                ...
		                for(var i=0; i<response.length; i++){
		                        data += '<tr>';
		                        data += '<td> <p>' + response[i]["searchDate"] +'</p> </td>';
		                        data += '<td> <p>' + response[i]["terms"] +'</p> </td>';
		                        data += '<td> <p>' + response[i]["count"] +'</p> </td>';
		                        data += '<td> <p>' + response[i]["timeToSearch"] +'</p> </td>';
		                        data +='</tr>';
		                }
